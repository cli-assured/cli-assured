...
public class OutputCaptureTest {
    ...
    void captureAll() throws IOException {
        ...
        Assertions.assertThat(result.lineCount()).isEqualTo(3);
        Assertions.assertThat(result.lines().count()).isEqualTo(3);
        Assertions.assertThat(result.lines().collect(Collectors.toList())).containsExactly("Line 0", "Line 1", "Line 2");
        Assertions.assertThat(result.bytes()).isEqualTo(sourceBytes);
    }
}
